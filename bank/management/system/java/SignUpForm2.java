...
public class SignUpForm2 extends JFrame{
    JLabel headingTitle, additionalDetails, religion, Income, Education, qualification, panCode, ExistAccount, SC, CnicNumber, occupation, category;
    JTextField CnicTextField, panCodeTextField;
    JRadioButton sYes, sNo, eYes, eNo;
    JComboBox Religion, Category, Occupation, income, Qualification, education;
    long formNO;
    
    SignUpForm2(long formNo) {
        this.formNO = formNo;
        setLayout(null);
        setSize(800, 750); 
        ...
        headingTitle.setBounds(140, 20, 600, 40);
        add(headingTitle);
        ...
        String valQualification[] = {"Null","Graduate","Under Graduate", "Post Graduate", "Doctorate", "Others"};
        ...
        panCodeTextField.setBounds(300, 439, 400, 30);
